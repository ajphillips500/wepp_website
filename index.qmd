...
For the nugget, the true parameter values were $\eta^2=0.01$, $0.05$, $0.1$, $0.5$, and $1$. I used a normal proposal distribution in the Metropolis-Hastings sampler.

For the spatial variance, the true parameter values were $\tau^2=0.5$, $1$, $2$, $4$, and $8$. I used a normal proposal distribution in the Metropolis-Hastings sampler.

For the lengthscale, the true parameter values were $\theta=0.1$, $0.5$, $1$, $5$, and $10$. I used a chi-squared proposal distribution in the Metropolis-Hastings sampler.
