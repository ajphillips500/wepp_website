...
Default algo on two new data sets.
[Plot new data sets]
...
[Plot posterior of mean, true mean fn] and describe the posteriors of $\alpha$ and $\phi$ and the typical cluster structure.

```{r, fig.show='hold', out.width="30%", fig.align='center'}
knitr::include_graphics(c('Reports/plot3-10-9-25.png', 'Reports2/plot1-10-9-25.png', 'Reports2/plot2-10-9-25.png'))
```


Repeat, fixing phi at small value.
Repeat, fixing alpha at a large value. Note any differences in the outcomes. 

### DDCRP Clustering

Just clustering algo on simdat, simdat2, simdat3.
Average number of clusters, shape of clusters.
[Plots of final cluster state for each data set]

```{r, fig.show='hold', out.width="30%", fig.align='center'}
  knitr::include_graphics(c('Reports2/plot4-10-9-25.png', 'Reports2/plot5-10-9-25.png', 'Reports2/plot6-10-9-25.png'))
```

Tried for different values of alpha, phi, and theta. No difference in overall structure. 
...
This issue might be reduced or resolved as we employ higher dimensional data.
