...
I updated the priors of my Metropolis Hastings sampler as discussed in the previous section, then implemented an adaptive proposal variance. Proposals for new parameters are now drawn from a multivariate normal distribution with covariance matrix $2.4^2S/d$, where $d$ is the number of parameters and $S$ is the sampling variance of the parameters. $S$ is updated every $1000$ iterations for the first ten thousand, based on samples already drawn. I discard these first $10000$ iterations as burn-in.
